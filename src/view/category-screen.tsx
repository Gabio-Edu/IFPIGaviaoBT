...
import { useCategoryViewModel } from "@/viewmodel/use-category-view-model";

export function CategoryScreen() {
  // A View apresenta os dados e encaminha interações para as actions.
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() => actions.navegarParaItem(item.id)}
            >
