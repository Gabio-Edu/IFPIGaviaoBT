...
import { useItemViewModel } from "@/viewmodel/use-item-view-model";

export function ItemScreen() {
  // A View só apresenta o state e chama as actions fornecidas pela ViewModel.
  const [state, actions] = useItemViewModel();
          ...
          <View style={styles.infoSecao}>
            ...
            <View style={styles.nutricaoLinha}>
              <Text style={styles.nutricaoItem}>
                Proteínas: <Text style={styles.nutricaoValor}>{state.produto.proteinas}</Text>
              </Text>
              <Text style={styles.nutricaoItem}>
                Carboidratos: <Text style={styles.nutricaoValor}>{state.produto.carboidratos}</Text>
              </Text>
              <Text style={styles.nutricaoItem}>
                Gorduras: <Text style={styles.nutricaoValor}>{state.produto.gorduras}</Text>
              </Text>
            </View>
...
// Os estilos foram movidos da rota sem alterações visuais.
