    ...
    <View style={styles.tela}>
      ...
      {state.carregando ? (
        ...
        <View style={styles.erroContainer}>
          <Text style={styles.erroTexto}>{state.erro}</Text>
        </View>
      ) : state.produto ? (
        <ScrollView
          ...
          <View style={styles.infoSecao}>
            ...
            <View style={styles.nutricaoLinha}>
              <Text style={styles.nutricaoItem}>
                Proteínas:{" "}
                <Text style={styles.nutricaoValor}>{state.produto.proteinas}</Text>
              </Text>
              <Text style={styles.nutricaoItem}>
                Carboidratos:{" "}
                <Text style={styles.nutricaoValor}>{state.produto.carboidratos}</Text>
              </Text>
              <Text style={styles.nutricaoItem}>
                Gorduras:{" "}
                <Text style={styles.nutricaoValor}>{state.produto.gorduras}</Text>
              </Text>
            </View>
