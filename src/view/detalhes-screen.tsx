...
export default function DetalhesScreen({
  ...
  } = useDetalhesViewModel(id);

  return (
    <View style={styles.tela}>
      {/* cabecalho roxo com botao de voltar */}
      ...
      {/* conteudo principal com rolagem */}
      {carregando ? (
        ...
        >
          ...
          {/* areas de detalhes de informacoes */}
