...
import { useCategoriasViewModel } from "../viewmodel/useCategoriasViewModel";

export default function HomeScreen() {
  const [state, actions] = useCategoriasViewModel();
          ...
          <View style={styles.gridCategorias}>
            {state.categorias.map((categoria) => (
              <TouchableOpacity
                ...
                onPress={() => actions.abrirCategoria(categoria.id)}
              >
